...
{
	RenderingEngine *engine = RenderableGame::getGlobalInstance()->getRenderingEngineInstance();	this->soundIndices[static_cast<int>(Sounds::SOUNDTRACK)] = engine->loadSound( "resources/lava.wav" );	
